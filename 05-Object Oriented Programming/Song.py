class Song(object):
    ...
    def __eq__(self, other):
        return self.artist == other.artist and self.title == other.title and self.duration == other.duration

    def __ne__(self, other):
        return not self.__eq__(other)

    def __str__(self):
        return f'Song with title {self.title} by {self.artist}'
...
class Album:
    ...
    def add_song(self, song, position=None):
        ...
        if song_exists_already:
            print(f'Album.add_song(): Ignoring a duplicate {song}')   # Calls Song.__str__()
        else:
            if position is None:
    ...
    def __str__(self):
        return f'Album with name {self.name} with year {self.year} by {self.artist}'

    def __eq__(self, other):
        return self.name == other.name and self.year == other.year and self.artist == other.artist
...
class Artist:
    ...
    def get_album(self, album_name, album_year):
        ...
        """
        result = None
        album_to_search = Album(album_name, album_year, self)
